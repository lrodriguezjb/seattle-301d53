...
// this is referring to the scope of the constructed student object. 
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//this is referring to the parent element window
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions use lexical scoping in this case the arrow function wasnt using the scope in which it was defined instead it was using the global object vs the regular function referring to the actual object.
